...
<html lang="en">
    ...
    <body class="min-s-screen relative">

        <div href="#" class="block mx-auto mt-36 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            @if ($errors->any())
            ...
            <form action="{{ route('auth.postLogin') }}" method="POST" class="max-w-sm mx-auto">
                @csrf
                <div class="mb-5">
