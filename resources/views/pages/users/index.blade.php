                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center">
                                    <a href="{{ route('users.report', $value->id) }}">
                                        <button type="button" class="text-white bg-yellow-500 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-yellow-500 dark:hover:bg-yellow-500 focus:outline-none dark:focus:ring-yellow-500">
                                            Attendance Report
                                        </button>
                                    </a>
